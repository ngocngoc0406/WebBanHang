...
<body onload="onload()"> 
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="billing-input">
									...
									<div id="district" name="district" onchange>
										<select>
										</select>
									</div>
										...
										<div id="collapseTwo" class="panel-collapse collapse"
											...
											<div class="panel-body">
												<p>
													...
													khoản: 030187772127 <br> Chủ tài khoản: Đặng Văn Nam
												</p>
											</div>
										</div>
									</div>
	...
	<script>
		...
		function loadData(){
			...
			AddressControl a= new AddressControl();
			ArrayList<Districts> list= a.getListDistricts(49);
